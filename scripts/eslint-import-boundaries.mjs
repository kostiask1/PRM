...
const RULES_REFERENCE_MODAL_STORE_FACADE_RULE =
	createInjectedRuntimeStoreFacadeRule({
		featurePathPrefix: RULES_REFERENCE_MODAL_WIDGET_PATH_PREFIX,
		description:
			"Require Rules Reference Modal to receive app-global navigation, history, and modal effects through its injected runtime.",
		messageId: "injectedRuntime",
		message:
...
const MONSTER_STAT_BLOCK_STORE_FACADE_RULE =
	createInjectedRuntimeStoreFacadeRule({
		featurePathPrefix: MONSTER_STAT_BLOCK_WIDGET_PATH_PREFIX,
		description:
			"Require Monster Stat Block to receive app-global campaigns, modal, error, reload, and dice effects through its injected runtime.",
		messageId: "injectedRuntime",
		message:
...
const SESSION_PAGE_STORE_FACADE_RULE = createInjectedRuntimeStoreFacadeRule({
	...
	description:
		"Require Session Page to receive app-global navigation, state, modal, and refresh effects through its injected runtime.",
	messageId: "injectedRuntime",
	message:
