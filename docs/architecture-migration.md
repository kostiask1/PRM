...
- Continue with the next bounded UI/controller contract slice; runtime validation remains authoritative for untrusted HTTP, filesystem, archive, and Gemini payloads.
