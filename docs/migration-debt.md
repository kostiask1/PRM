...
| MD-R02 / Phase 250 | Completed Bestiary widget-model consolidation | Moved Bestiary legendary-group lookup and monster enrichment into private `widgets/bestiary-browser/model/bestiaryBrowserLegendary.ts`. `bestiaryBrowser.ts` retains the compatibility facade. | Preserve group/reference source-name resolution, canonical identity matching, unmatched monster identity, and lair/regional projection without public widget/model expansion. | 523/523 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 251 | Completed Bestiary widget-model consolidation | Moved Bestiary canonical identity/reference parsing, custom lookup, clone/equality, selection, custom-refresh, and initial-scroll plans into private `widgets/bestiary-browser/model/bestiaryBrowserSelection.ts`. `bestiaryBrowser.ts` retains the compatibility facade. | Preserve normalization/read order, nullable reference behavior, official-first automatic selection, explicit displayed-before-all lookup, custom refresh precedence, and scroll-key semantics without public widget/model expansion. | 524/524 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 252 | Completed Bestiary widget-model consolidation | Moved Bestiary list-row and detail presentation into private `widgets/bestiary-browser/model/bestiaryBrowserPresentation.ts`. `bestiaryBrowser.ts` retains the compatibility facade. | Preserve canonical selected/favorite/custom identity, token/CR fallbacks, primary-action precedence, lazy add-title resolution, custom-only deletion, callback identity, and no public widget/model expansion. | 525/525 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 253 | Completed Bestiary widget-model consolidation | Moved Bestiary response normalization, custom import/merge, updated-list/selection projection, and delete/favorite policies into private `widgets/bestiary-browser/model/bestiaryBrowserCustomData.ts`. `bestiaryBrowser.ts` retains the compatibility facade. | Preserve response candidate precedence, runtime narrowing, custom-source replacement, normalized-name import overwrite order, generated-before-requested selection, undo policy, and exact custom-favorite removal without public widget/model expansion. | 526/526 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 254 | Completed Bestiary widget-model consolidation | Moved Bestiary field-edit create-based/payload/start policies and injected save execution into private `widgets/bestiary-browser/model/bestiaryBrowserFieldEditing.ts`. `bestiaryBrowser.ts` retains the compatibility facade. | Preserve custom versus official start modes, monster/draft identity, token fallback, duplicate detection, nullish image precedence, mode-specific previous-name behavior, callback order, and failure outcomes without public widget/model expansion. | 527/527 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 255 | Completed Bestiary widget-model consolidation | Moved Bestiary AI generation-result normalization and draft/update planning into private `widgets/bestiary-browser/model/bestiaryBrowserAiResults.ts`. `bestiaryBrowser.ts` retains the compatibility facade. | Preserve record narrowing, generated-list normalization, draft image enrichment, draft-before-update precedence, edit-only selection, `trackUndo: false`, and no public widget/model expansion. | 528/528 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 256 | Completed Bestiary widget-model consolidation | Moved Bestiary AI instruction/start-request, cancellation/error, controller-identity, and request-execution policies into private `widgets/bestiary-browser/model/bestiaryBrowserAiRequest.ts`. `bestiaryBrowser.ts` retains the compatibility facade. | Preserve create-based instruction joining, target/instruction guards, exact generation payload, abort suppression, applied/reset/error order, always-settle behavior, and no public widget/model expansion. | 529/529 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 257 | Completed Bestiary widget-model consolidation | Moved Bestiary AI draft restore/undo start, result/update, execution, and resource-metadata policies into private `widgets/bestiary-browser/model/bestiaryBrowserAiDraftRestore.ts`. `bestiaryBrowser.ts` now serves solely as the compatibility facade. | Preserve restore guard/clone timing, apply/undo dispatch, changed-selection derivation, no-op undo snapshot detection, callback order, busy finalization, and image/original-name metadata fallback without public widget/model expansion. | 530/530 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 258 | Completed Bestiary widget UI decomposition | Moved the virtualized Bestiary row, row actions, and row content into private `widgets/bestiary-browser/ui/BestiaryMonsterListItem.tsx`. `BestiaryContent.tsx` retains the list/detail composition boundary. | Preserve primary-action routing, stopped action clicks, favorite/custom action availability, token/source/CR presentation, selection/double-click behavior, and no public widget entry expansion. | 531/531 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 259 | Completed Bestiary widget UI decomposition | Moved the Bestiary source/search/favorite/sort toolbar into private `widgets/bestiary-browser/ui/BestiaryToolbar.tsx`. `BestiaryContent.tsx` retains the list/detail composition boundary. | Preserve source selection/filter callbacks, source labels, search/deep-search controls, favorite/sort controls, header-action rendering, and no public widget entry expansion. | 532/532 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 260 | Completed Bestiary widget UI decomposition | Moved the Bestiary detail panel into private `widgets/bestiary-browser/ui/BestiaryDetail.tsx`. `BestiaryContent.tsx` retains the list/detail composition boundary. | Preserve selected-monster detail presentation, insert-action visibility/routing, stat-block callback contracts, favorite updates, search highlighting, and no public widget entry expansion. | 533/533 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 261 | Completed Bestiary widget UI decomposition | Moved the Bestiary virtualized list and its scroll-parent policy into private `widgets/bestiary-browser/ui/BestiaryVirtualizedList.tsx`. `BestiaryContent.tsx` retains the list/detail composition boundary. | Preserve loading visibility, item renderer identity, list ref, mobile scroll parent/viewport fallbacks, uniform list behavior, and no public widget entry expansion. | 534/534 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 262 | Completed Bestiary widget UI decomposition | Moved Bestiary mobile selection and list/detail scrolling into private `widgets/bestiary-browser/ui/useBestiaryMobileSelection.ts`. `BestiaryContent.tsx` retains the list/detail composition boundary. | Preserve state-update-before-scroll ordering, mobile-only guards, selected-identity lookup, animation-frame cancellation, detail smooth-scroll options, and no public widget entry expansion. | 535/535 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 263 | Completed Bestiary widget UI decomposition | Moved Bestiary source filtering, ignored-source selection, reset-on-unavailable-source, labeling, and persistence orchestration into private `widgets/bestiary-browser/ui/useBestiarySourceSelection.ts`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve source normalization, custom-source behavior, campaign/global persistence routing, auto-selection re-enable timing, error/log callbacks, and no public widget entry expansion. | 536/536 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 264 | Completed Bestiary widget UI decomposition | Moved Bestiary search-control state into private `widgets/bestiary-browser/ui/useBestiarySearchControls.ts`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve initial search and detailed-search synchronization, debounce timing policy, setters, and no public widget entry expansion. | 537/537 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 265 | Completed Bestiary widget UI decomposition | Moved Bestiary filtered-list state and projection into private `widgets/bestiary-browser/ui/useBestiaryMonsterList.ts`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve filtering policy inputs, favorite-only state, sorting transitions, filtered-to-sorted projection, and no public widget entry expansion. | 538/538 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 266 | Completed Bestiary widget UI decomposition | Moved Bestiary selected-monster state and direct user selection into private `widgets/bestiary-browser/ui/useBestiaryMonsterSelectionState.ts`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve selection/ref synchronization, manual-selection auto-selection disablement, active-monster callback eligibility, initial-reference scroll reset, and no public widget entry expansion. | 539/539 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 267 | Completed Bestiary widget UI decomposition | Moved Bestiary automatic selection and initial list-scroll effects into private `widgets/bestiary-browser/ui/useBestiaryMonsterSelectionLifecycle.ts`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve selection-plan identity guards, explicit-selection auto-disablement, ref-before-state-update ordering, initial scroll key guards, animation-frame cleanup, and no public widget entry expansion. | 540/540 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 268 | Completed Bestiary widget UI decomposition | Moved Bestiary favorite-toggle orchestration into private `widgets/bestiary-browser/ui/useBestiaryFavoriteToggle.ts`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve source string coercion, favorite-list replacement, failure logging, injected API transport, and no public widget entry expansion. | 541/541 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 269 | Completed Bestiary widget UI decomposition | Moved Bestiary editor/action/draft modal composition into private `widgets/bestiary-browser/ui/BestiaryBrowserModals.tsx`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve field-editor callbacks, custom-source global-edit visibility, AI modal prop routing, apply/undo resource callbacks, and no public widget entry expansion. | 542/542 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 270 | Completed Bestiary widget UI decomposition | Moved Bestiary header-action and list/detail content composition into private `widgets/bestiary-browser/ui/BestiaryBrowserContent.tsx`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve content prop routing, header-action enablement, import/export/undo/redo callbacks, assistant/modal slots, and no public widget entry expansion. | 543/543 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 271 | Completed Bestiary widget UI decomposition | Moved Bestiary AI draft apply/undo callback adaptation into private `widgets/bestiary-browser/ui/BestiaryBrowserModals.tsx`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve all four draft restore routes, their apply/undo mode and resource-ID payloads, modal slot contract, and no public widget entry expansion. | 544/544 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 272 | Completed Bestiary widget UI decomposition | Moved Bestiary Browser-owned state and non-workflow refs into private `widgets/bestiary-browser/ui/useBestiaryBrowserState.ts`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve state/ref initialization order, all setter/ref identities supplied to workflows and UI hosts, and no public widget entry expansion. | 545/545 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 273 | Completed Bestiary widget model decomposition | Moved Bestiary AI edit request-controller lifecycle into private `widgets/bestiary-browser/model/useBestiaryAiWorkflows.ts`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve request cancellation, replacement guards, unmount abort, settled-controller clearing, workflow command identity, and no public widget entry expansion. | 546/546 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 274 | Completed Bestiary widget UI decomposition | Moved Bestiary Browser API aggregation and localized history/diff adapters into private `widgets/bestiary-browser/ui/bestiaryBrowserDependencies.ts`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve API spread order, translation output, helper signatures, source-selection/favorite transport routing, and no public widget entry expansion. | 547/547 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 275 | Completed Bestiary widget lifecycle decomposition | Moved Bestiary sync-event and initial monster-reference normalization to their private lifecycle owners. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve memoized identity by raw input, selection/scroll plan inputs, sync effect dependency, and no public widget entry expansion. | 548/548 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R02 / Phase 276 | Completed Bestiary widget UI decomposition | Moved Bestiary assistant image-prompt registration and dispatch into private `widgets/bestiary-browser/ui/useBestiaryImagePromptBridge.ts`. `BestiaryBrowser.tsx` retains UI orchestration. | Preserve ref-held action replacement, nullable handler support, selected-monster dispatch, workflow callback routing, and no public widget entry expansion. | 549/549 tests; architecture maintained; `MD-R02` remains closed; `MD-R04` remains open |
| MD-R04 | Closed | Phase 291 restored the declared local tooling and resolved the strict runtime-contract drift exposed by complete validation. Fallow reports zero boundary violations or cycles; complete lint and strict typecheck pass. | Keep the declared tooling available and retain the complete lint/typecheck gates alongside architecture, test, performance, and UTF-8 checks. | Closed at Phase 291 |
